...
describe('wpk-config reference', () => {
	...
	const REQUIRED_SNIPPETS = [
		...
		'`resources.<key>.cacheKeys.list`',
		'`resources.<key>.cacheKeys.get`',
		'`resources.<key>.cacheKeys.create`',
		'`resources.<key>.cacheKeys.update`',
		'`resources.<key>.cacheKeys.remove`',
		'`resources.<key>.store.getId`',
		'`resources.<key>.store.getQueryKey`',
		'`resources.<key>.store.initialState`',
		...
		'`resources.<key>.ui.admin.dataviews.mapQuery`',
		'`resources.<key>.ui.admin.dataviews.search`',
		'`resources.<key>.ui.admin.dataviews.searchLabel`',
		'`resources.<key>.ui.admin.dataviews.getItemId`',
