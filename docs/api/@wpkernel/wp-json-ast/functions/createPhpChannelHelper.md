...
[@wpkernel/wp-json-ast](../index.md) / createPhpChannelHelper

# Function: createPhpChannelHelper()

```ts
function createPhpChannelHelper&lt;TContext, TInput, TOutput&gt;(options): BuilderHelper&lt;TContext, TInput, TOutput&gt;;
```
