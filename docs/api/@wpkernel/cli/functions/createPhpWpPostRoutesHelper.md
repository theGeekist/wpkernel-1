...
[@wpkernel/cli](../index.md) / createPhpWpPostRoutesHelper

# Function: createPhpWpPostRoutesHelper()

```ts
function createPhpWpPostRoutesHelper(): BuilderHelper;
```
...
A `BuilderHelper` instance for WP Post routes.
