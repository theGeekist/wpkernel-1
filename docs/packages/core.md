...
This page summarises the package README. For the authoritative reference see [packages/core/README.md](https://github.com/theGeekist/wp-kernel/blob/main/packages/core/README.md).
:::
...
```typescript
import { defineJob } from '@wpkernel/core/job';
...
```typescript
import { resource, actions, error } from '@wpkernel/core';
...
```typescript
import { defineResource, defineAction, KernelError } from '@wpkernel/core';
```
