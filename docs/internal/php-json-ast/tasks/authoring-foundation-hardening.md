...
base_sha: '47dace415da811c9a296b34e505e5c79a89180b7'
...
- `pnpm --filter @wpkernel/php-json-ast test -- --runInBand`: 29 suites,
  187 tests passed after exposing the existing Composer vendor assets to the
