...
- `wpk generate` emits storage-derived TypeScript definitions, PHP controllers, UI scaffolds, and block assets during a single invocation, coordinating builders through the CLI pipeline.【F:packages/cli/src/builders/ts/ts.types.ts†L1-L106】【F:packages/cli/src/builders/index.ts†L1-L17】
