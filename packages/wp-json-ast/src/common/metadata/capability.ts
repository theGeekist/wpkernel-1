import type {
	...
	CapabilityFallback,
	CapabilityMapWarning,
} from '../../capability/types';
import type { CapabilityHelperMetadata } from '../../types';

export interface BuildCapabilityHelperMetadataOptions {
...
export function buildCapabilityHelperMetadata(
	options: BuildCapabilityHelperMetadataOptions
	...
	} satisfies CapabilityHelperMetadata;
}
