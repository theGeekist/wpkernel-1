...
- Version bump to `0.11.0` to align with the Phase 7 plugin bootstrap flow release; existing test harness helpers already cover the new pipeline execution path.
