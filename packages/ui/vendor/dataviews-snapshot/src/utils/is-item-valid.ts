	...
	return _fields.every((field) => {
		...
		if (field.isValid.required) {
			if (
				...
				(field.type === 'telephone' && isEmptyNullOrUndefined(value)) ||
				(field.type === 'password' && isEmptyNullOrUndefined(value)) ||
				(field.type === 'integer' && isEmptyNullOrUndefined(value)) ||
				(field.type === 'number' && isEmptyNullOrUndefined(value)) ||
				(field.type === 'array' &&
