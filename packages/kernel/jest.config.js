/**
 * Jest configuration for @geekist/wp-kernel package
...
export default {
	...
	testMatch: [
		'<rootDir>/packages/kernel/**/__tests__/**/*.ts',
		'<rootDir>/packages/kernel/**/__tests__/**/*.tsx',
		'<rootDir>/packages/kernel/**/__tests__/**/*.test.ts',
		'<rootDir>/packages/kernel/**/__tests__/**/*.test.tsx',
	],
