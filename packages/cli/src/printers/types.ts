...
import type { PhpFileAst } from './php/builder';
...
export interface PhpPrettyPrintOptions {
	...
	ast?: PhpJsonAst;
	/**
	 * Legacy structural representation generated by the existing printers.
	 * Provided so the bridge can continue validating string-based output until
	 * the generators migrate to first-class AST emission.
	 */
	legacyAst?: PhpFileAst;
}
