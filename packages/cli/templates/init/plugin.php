 ...
 * Description: Bootstrap loader for the __WPK_PLUGIN_TITLE__ WPKernel integration.
 * Version: 0.1.0
 ...
 * It is responsible for bootstrapping the WPKernel runtime and
 * registering your plugin's REST API routes.
 *
 * Edits between `WPK:BEGIN AUTO` and `WPK:END AUTO` are managed by the WPKernel CLI.
 * You can add your own code outside of these blocks.
 *
 * @see https://github.com/wpkernel/wpkernel/blob/main/docs/guide/actions.md
 * @see https://github.com/wpkernel/wpkernel/blob/main/docs/guide/resources.md
 */
// WPK:BEGIN AUTO
if (!\defined('ABSPATH')) {
        exit;
 ...
 *
 * This function is auto-generated by the WPKernel CLI.
